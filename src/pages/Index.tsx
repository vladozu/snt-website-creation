  ...
  const newsItems = [
    {
      ...
      date: "01.12.2024",
      content:
        "Уважаемые садоводы! 15 декабря в 12:00 состоится годовое отчетно-выборное собрание.",
      type: "важно",
    },
    {
      id: 2,
      ...
      date: "28.11.2024",
      content:
        "Завершены работы по ремонту дорожного покрытия на участках 1-25.",
      type: "новость",
    },
    {
      id: 3,
      ...
      date: "25.11.2024",
      content:
        "Убедительная просьба погасить задолженность по членским взносам до 31 декабря.",
      type: "объявление",
    },
  ];
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2 text-secondary">
              ...
              <span className="font-medium">+7 (916) XXX-XX-XX</span>
            </div>
          </div>
        </div>
      </header>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Добро пожаловать на официальный сайт садоводческого
                некоммерческого товарищества "Лесная Сказка". Здесь вы найдете
                всю актуальную информацию о жизни нашего товарищества.
              </p>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium">
                        {paymentData.collected.toLocaleString("ru-RU")} ₽
                      </span>
                    </div>
                    ...
                    <div className="flex justify-between text-sm text-muted-foreground">
                      ...
                      <span>
                        Осталось: {paymentData.pending.toLocaleString("ru-RU")}{" "}
                        ₽
                      </span>
                    </div>
                    <Dialog>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-sm text-secondary-foreground/80">
                Садоводческое некоммерческое товарищество, основанное в 1985
                году. Площадь территории: 15 гектаров, 120 участков.
              </p>
            </div>
