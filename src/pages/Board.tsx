...
export default function Board() {
  const [members, setMembers] = useState<BoardMember[]>([
    {
      ...
      phone: '+7 (916) 840-07-18',
      email: 'fio_admin@mail.ru',
      experience: '2018 - настоящее время',
      responsibilities: ['Общее руководство СНТ', 'Взаимодействие с органами власти', 'Координация работы правления']
    },
    {
      id: '2',
      ...
      responsibilities: ['Решение хозяйственных вопросов', 'Контроль коммунальных услуг', 'Благоустройство территории']
    },
    {
      id: '3',
      ...
      responsibilities: ['Ведение финансовой отчетности', 'Сбор членских взносов', 'Планирование бюджета СНТ']
    },
    {
      id: '4',
      ...
      responsibilities: ['Ведение протоколов собраний', 'Документооборот', 'Информирование садоводов']
    }
  ]);
  ...
  const handleAddMember = () => {
    if (newMember.name && newMember.position && newMember.phone) {
      ...
      setNewMember({ name: '', position: '', phone: '', email: '', experience: '', responsibilities: '' });
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Состав правления и контактная информация руководства СНТ "Лесная сказка"
            </p>
          </div>

          <div className="bg-white rounded-lg shadow-sm border p-6 mb-8">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-semibold text-gray-900">Члены правления</h2>
              <button
            ...
            {showAddForm && (
              <div className="bg-gray-50 p-6 rounded-lg mb-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Новый член правления</h3>
                ...
                >
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <a href={`tel:${member.phone}`} className="text-gray-700 hover:text-green-600">
                        {member.phone}
                      </a>
                    </div>
                    ...
                    {member.email && (
                      <div className="flex items-center gap-3">
                        ...
                        <a href={`mailto:${member.email}`} className="text-gray-700 hover:text-green-600">
                          {member.email}
                        </a>
                      </div>
                    )}
            ...
            <div className="mt-8 bg-green-50 p-6 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  <h4 className="font-medium text-gray-900 mb-2">Рабочие дни:</h4>
